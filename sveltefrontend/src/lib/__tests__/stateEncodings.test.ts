...
describe("stateEncodings", () => {
  ...
  it("increaseState6", () => expect(increaseState("f", 1)).toEqual("3") );
  it("increaseState7", () => expect(increaseState("af456c", 1)).toEqual("af4560") );
  it("increaseState8", () => expect(increaseState("af456c", 2)).toEqual("af457c") );
  it("increaseState9", () => expect(increaseState("af456c", 6)).toEqual("af556c") );
  it("increaseState10", () => expect(increaseState("af456c", 20)).toEqual("10000af456c") );
  it("increaseState11", () => expect(increaseState("af456c", 21)).toEqual("40000af456c") );
  it("increaseState12", () => expect(increaseState("40000af456c", 22)).toEqual("140000af456c") );
});